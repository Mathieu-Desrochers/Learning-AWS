...
VPC, Private network (in region) with CIDR range (172.31.0.0/16), Accounts get defaultVPC  
Subnets with CIDR subrange (in AZ), Public or private (accessibility from internet)  
...
Site to Site VPN, On premise to VPC over internet, Direct Connect (DX), Over private physical connection  
